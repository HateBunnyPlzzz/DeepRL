...
class ActorNetwork(nn.Module):
    ...
    def forward(self, state):
        ...
        #std deviation should not be very broad, some finite constraint value
    ...
    def sample_normal(self, state, reparameterize=True):
        ...
        action = T.tanh(actions)*T.tensor(self.max_action).to(self.device) #not drawn from the distribution
